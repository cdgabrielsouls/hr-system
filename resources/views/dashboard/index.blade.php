...
<body class="w-full min-h-screen bg-navy-bg text-white font-sans opacity-0 animate-pageFade">
  ...
  <!-- =====================================================
       TOP NAVBAR
  ====================================================== -->
  <header class="h-[150px] bg-navy-top border-b border-white/[.03] shadow-[0_1px_0_rgba(255,255,255,.03)_inset] flex items-center justify-between pl-px pr-5 relative z-10">

    <!-- Brand -->
    <div class="flex items-center">
      <img src="{{ asset('images/logo.png') }}" alt="Header Logo" class="h-[86px] w-auto object-contain">
    </div>

    <div class="flex items-center gap-7">
      <nav class="hidden lg:flex items-center gap-px">

        <div class="relative group">
          <a href="dashboard"
             class="flex items-center gap-2 rounded-full px-[18px] py-2.5 text-white text-xl transition
                    hover:text-accent-soft hover:bg-[#1B3A6B] hover:-translate-y-px hover:font-bold">
            Dashboard
          </a>
        </div>
        ...
        <div class="relative group">
          <a href="#"
             class="flex items-center gap-2 rounded-full px-[18px] py-2.5 text-white text-xl transition
                    hover:text-accent-soft hover:bg-[#1B3A6B] hover:-translate-y-px hover:font-bold">
            Workforce
            <svg class="w-3.5 h-3.5 opacity-80 transition-transform duration-300 group-hover:rotate-180" viewBox="0 0 24 24" fill="none">
              <path d="M6 9L12 15L18 9" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </a>
          <div class="absolute top-full left-1/2 -translate-x-1/2 translate-y-2 w-56 bg-navy-top rounded-2xl p-2.5
                      shadow-[0_20px_45px_rgba(0,0,0,.25)] opacity-0 invisible transition-all duration-300 z-50
                      group-hover:opacity-100 group-hover:visible group-hover:translate-y-0">
            <a href="{{ route('employees.index') }}" class="block rounded-xl px-3.5 py-2.5 text-sm font-medium text-[#C9DAF8] transition hover:bg-slate-50 hover:text-accent">Employee List</a>
            <a href="{{ route('departments.index') }}" class="block rounded-xl px-3.5 py-2.5 text-sm font-medium text-[#C9DAF8] transition hover:bg-slate-50 hover:text-accent">Department List</a>
          </div>
        </div>
        ...
        <div class="relative group">
          ...
          <div class="absolute top-full left-1/2 -translate-x-1/2 translate-y-2 w-56 bg-navy-top rounded-2xl p-2.5
                      shadow-[0_20px_45px_rgba(0,0,0,.25)] opacity-0 invisible transition-all duration-300 z-50
                      group-hover:opacity-100 group-hover:visible group-hover:translate-y-0">
            <a href="#" class="block rounded-xl px-3.5 py-2.5 text-sm font-medium text-[#C9DAF8] transition hover:bg-slate-50 hover:text-accent">Leave Management</a>
            <a href="#" class="block rounded-xl px-3.5 py-2.5 text-sm font-medium text-[#C9DAF8] transition hover:bg-slate-50 hover:text-accent">Resignation</a>
          </div>
        </div>
      </nav>
      ...
      <!-- Profile -->
      <div class="relative group">
        <div class="w-11 h-11 rounded-full grid place-items-center bg-white/[.06] shadow-[inset_0_0_0_1px_rgba(255,255,255,.06)] cursor-pointer">
        ...
        <div class="absolute top-full right-0 translate-y-2 w-40 bg-navy-top rounded-2xl p-2
                    shadow-[0_20px_45px_rgba(0,0,0,.25)] opacity-0 invisible transition-all duration-300 z-50
                    group-hover:opacity-100 group-hover:visible group-hover:translate-y-0">
          <form method="POST" action="{{ route('logout') }}">
            ...
            <button type="submit" class="w-full text-left">
              <a href="#" onclick="event.preventDefault(); this.closest('form').submit();"
                 class="flex items-center gap-2 rounded-xl px-3 py-2.5 text-sm font-semibold text-[#FFB4B4] transition hover:bg-[#2c1414] hover:text-[#ff6b6b]">
